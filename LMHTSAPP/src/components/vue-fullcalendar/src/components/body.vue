...
.full-calendar-body{
  ...
  .dates {
    ...
    .dates-events{
      ...
      .events-week{
        ...
        .events-day{
          cursor: pointer;
          flex:1;
          min-height: 109/$r+rem;
          overflow: hidden;
          text-overflow: ellipsis;
          .day-number{
            text-align: right;
            padding:4/$r+rem 5/$r+rem 4/$r+rem 4/$r+rem;
            opacity: 0;
          }
          &.not-cur-month{
            .day-number{
          ...
          .event-box{
            ...
            .more-link{
              cursor: pointer;
              // text-align: right;
              padding-left: 8/$r+rem;
              padding-right: 2/$r+rem;
              color: rgba(0,0,0,.38);
              font-size: 14/$r+rem;
            }
          }
    ...
    .more-events{
      ...
      box-shadow: 0 2/$r+rem 6/$r+rem rgba(0,0,0,.15);
      .more-header{
