...
export default {
 ...
 /*     url: "httpConfig.websocketIp",*/
      ...
      onMessage(message) {
        ...
        console.log("client"+_this.mesg[0].Client)
        console.log("message"+_this.mesg)
        AgreeSDK.ui.toast('收到'+_this.mesg[0].Client+'消息:'+_this.mesg[0].msg);
        ...
        AgreeSDK.notification.createMessage({
          title: '收到'+_this.mesg[0].Client+'消息:',
          content: _this.mesg[0].msg,
          data: {
          }
        });
