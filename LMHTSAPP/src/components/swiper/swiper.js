...
class Swiper {
  ...
  /*  if(me._options.disabled){
      console.log(66666);
      me.$container.removeEventListener('touchstart', me.touchstartHandler, false)
      me.$container.removeEventListener('touchmove', me.touchmoveHandler, false)
      me.$container.removeEventListener('touchend', me.touchendHandler, false)
    }else{
